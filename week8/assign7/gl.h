 ...
 * @param ch  the character to be drawn, e.g. 'a'. If this character has no
 * glyph in the current font, nothing is drawn (refer to font_get_char())
 ...
 *
 * @param x    the x location of the upper left corner of the first char of
 * string
 * @param y    the y location of the upper left corner of the first char of
 * string
 ...
 * framebuffer are drawn. Any pixel that lies outside is clipped (i.e. not
 * drawn).
 *
